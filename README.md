...
|----------------|-----------|
|DayOfYearVersionProvider <sup>\[[8](#date-time-based-version-provider), [11](#version-provider-right-justified-zero-padded)\]</sup>|Yields the Day of Year in the form `d`.|
|DayVersionProvider <sup>\[[8](#date-time-based-version-provider), [11](#version-provider-right-justified-zero-padded)\]</sup>|Yields the Day of the Month in the form `d`.|
...
|ShortYearDayOfYearMultipartVersionProvider <sup>\[[8](#date-time-based-version-provider), [11](#version-provider-right-justified-zero-padded)\]</sup>|Yields the Short Year and Day of Year multipart element in the form `YYDDD`.|
...
|YearDayOfYearMultipartVersionProvider <sup>\[[8](#date-time-based-version-provider), [11](#version-provider-right-justified-zero-padded)\]</sup>|Yields the Year and Day of Year multipart element in the form `YYYYDDD`.|
